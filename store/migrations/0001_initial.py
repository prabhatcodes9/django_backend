# Generated by Django 5.2.4 on 2025-08-01 13:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('B', 'Bronze'), ('G', 'Gold'), ('D', 'Diamond')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Promotion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orders', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='store.customers')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
